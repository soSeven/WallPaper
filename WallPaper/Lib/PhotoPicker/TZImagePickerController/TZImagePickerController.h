...
/// 默认是NO，如果设置为YES，当照片选择时照片会显示颜色为canSelectLayerColor的浮层
@property (assign, nonatomic) BOOL showPhotoCanSelectLayer;
/// Default is red color with 0.8 alpha;
@property (strong, nonatomic) UIColor *canSelectLayerColor;
...
@property (nonatomic, strong) UIColor *naviBgTintColor;
