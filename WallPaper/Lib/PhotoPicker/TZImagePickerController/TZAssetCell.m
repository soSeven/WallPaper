...
- (void)reload:(NSNotification *)noti {
    ...
    self.cannotSelectLayerButton.userInteractionEnabled = YES;
    if (tzImagePickerVc.selectedModels.count >= tzImagePickerVc.maxImagesCount && tzImagePickerVc.showPhotoCannotSelectLayer && !self.model.isSelected) {
        ...
        if (tzImagePickerVc.showPhotoCanSelectLayer && self.model.isSelected) {
            self.cannotSelectLayerButton.backgroundColor = tzImagePickerVc.canSelectLayerColor;
            self.cannotSelectLayerButton.hidden = NO;
            self.cannotSelectLayerButton.userInteractionEnabled = NO;
        }
        else {
