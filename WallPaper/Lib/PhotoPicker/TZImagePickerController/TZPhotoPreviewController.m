...
- (void)configBottomToolBar {
    ...
    if (_tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:[UIImage tz_imageNamedFromMyBundle:@"preview_original_choose_def"] forState:UIControlStateSelected];
    ...
    [_doneButton setBackgroundColor:[UIColor colorWithRed:255/255.0 green:32/255.0 blue:113/255.0 alpha:1.0]];
    NSString *title = _tzImagePickerVc.doneBtnTitleStr;
    if (_tzImagePickerVc.selectedModels.count > 0) {
        title = [NSString stringWithFormat:@"%@(%zd)", _tzImagePickerVc.doneBtnTitleStr, _tzImagePickerVc.selectedModels.count];
    }
...
//        _tzImagePickerVc.photoPreviewPageUIConfigBlock(_collectionView, _naviBar, _backButton, _selectButton, _indexLabel, _toolBar, _originalPhotoButton, _originalPhotoLabel, _doneButton, _numberImageView, _numberLabel);
        _tzImagePickerVc.photoPreviewPageUIConfigBlock(_collectionView, _naviBar, _backButton, _selectButton, _indexLabel, _toolBar, _originalPhotoButton, _originalPhotoLabel, _doneButton, nil, nil);
    }
}
...
- (void)viewDidLayoutSubviews {
    ...
    _backButton.frame = CGRectMake(7, 20 + statusBarHeightInterval, 44, 44);
...
//    [_doneButton sizeToFit];
    ...
    _doneButton.frame = CGRectMake(self.view.tz_width - doneButtonWidth - 12, (44 - 32)*0.5, doneButtonWidth, 32);
...
//        _tzImagePickerVc.photoPreviewPageDidLayoutSubviewsBlock(_collectionView, _naviBar, _backButton, _selectButton, _indexLabel, _toolBar, _originalPhotoButton, _originalPhotoLabel, _doneButton, _numberImageView, _numberLabel);
        _tzImagePickerVc.photoPreviewPageDidLayoutSubviewsBlock(_collectionView, _naviBar, _backButton, _selectButton, _indexLabel, _toolBar, _originalPhotoButton, _originalPhotoLabel, _doneButton, nil, nil);
    }
}
...
//        _tzImagePickerVc.photoPreviewPageDidRefreshStateBlock(_collectionView, _naviBar, _backButton, _selectButton, _indexLabel, _toolBar, _originalPhotoButton, _originalPhotoLabel, _doneButton, _numberImageView, _numberLabel);
        _tzImagePickerVc.photoPreviewPageDidRefreshStateBlock(_collectionView, _naviBar, _backButton, _selectButton, _indexLabel, _toolBar, _originalPhotoButton, _originalPhotoLabel, _doneButton, nil, nil);
    }
}
