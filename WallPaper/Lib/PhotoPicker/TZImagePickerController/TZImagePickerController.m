...
- (void)setNaviBgTintColor:(UIColor *)naviBgTintColor
{
    _naviBgTintColor = naviBgTintColor;
    self.navigationBar.tintColor = naviBgTintColor;
}
...
- (void)configDefaultSetting {
    ...
    self.canSelectLayerColor = [[UIColor redColor] colorWithAlphaComponent:0.8];
...
- (void)setShowPhotoCanSelectLayer:(BOOL)showPhotoCanSelectLayer
{
    _showPhotoCanSelectLayer = showPhotoCanSelectLayer;
    [TZImagePickerConfig sharedInstance].showPhotoCanSelectLayer = showPhotoCanSelectLayer;
}
