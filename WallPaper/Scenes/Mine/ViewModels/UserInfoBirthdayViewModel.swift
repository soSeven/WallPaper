//
//  UserInfoBirthdayViewModel.swift
//  WallPaper
//
...
class UserInfoBirthdayViewModel: ViewModel, ViewModelType {
    ...
    func requestSave(value: String) -> Observable<Void> {
        ...
        return NetManager.requestResponse(.changeUserInfo(type: .constellation, value: value)).asObservable().trackError(error).trackActivity(loading)
    }
